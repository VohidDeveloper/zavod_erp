    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-12">
      <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600 mt-2">Ro'yxatdan o'tish</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          <form @submit.prevent="handleRegister">
            ...
            <div class="mb-6">
              ...
              <span v-if="errors.password_confirmation" class="text-red-500 text-sm mt-1">{{ errors.password_confirmation }}</span>
            </div>
            ...
            <div class="mb-6">
              <label class="flex items-start">
                ...
                <span class="ml-2 text-sm text-gray-600">
                  Men 
                  <a href="#" class="text-blue-600 hover:text-blue-700 font-medium">Foydalanish shartlari</a>
                  va
                  <a href="#" class="text-blue-600 hover:text-blue-700 font-medium">Maxfiylik siyosati</a>
